...
MAVEN_PAREMENT_FIELDS = [('maven_' + key[0], xmlutils.namespace_unaware(key[1]), sub_xpath_list) for key, sub_xpath_list in MAVEN2_PARENT_FILEDS]
...
def extract_pom_data(xdoc, fields=MAVEN_FIELDS, parent_fields=MAVEN_PAREMENT_FIELDS):
    """
